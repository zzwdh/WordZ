...
| 分析任务取消与并发保护 | 92% | 已有运行时 task supervisor，KWIC / Compare / Keyword / Topics / Sentiment 主来源、Topics 片段派生 Sentiment、Plot / Ngram / Cluster / Collocate 都已走“只应用最新结果”保护，API queued / in-flight 取消已覆盖 | 把用户可见取消状态从 failed/cancelled 文案进一步区分，并继续把 Stats/Word/Tokenize/ChiSquare/Locator 这类短任务保持在低风险抽查范围内 |
