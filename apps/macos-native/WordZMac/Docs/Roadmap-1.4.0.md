...
| 分析任务取消与并发保护 | 70% | 已有运行时 task supervisor，KWIC / Compare / Keyword / Topics 已走“只应用最新结果”保护，Topics 普通长任务新增取消传播和旧结果丢弃，API queued / in-flight 取消已覆盖 | 继续覆盖 Sentiment 等剩余长任务，并把用户可见取消状态从 failed/cancelled 文案进一步区分 |
