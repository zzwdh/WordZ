...
package struct TableExportService {
    package init() {}

    package func makeTSV(snapshot: NativeTableExportSnapshot) -> String {
    ...
    package func writeCSV(snapshot: NativeTableExportSnapshot, to path: String) throws {
    ...
    @discardableResult
    package func writeMetadataSidecar(snapshot: NativeTableExportSnapshot, forCSVPath path: String) throws -> String {
