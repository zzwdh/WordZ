...
package struct ReleaseVersionComparator {
...
package enum GitHubReleaseAssetSelector {
...
package enum GitHubReleasePayloadParser {
    package static func errorMessage(from data: Data) -> String? {
        guard
    ...
    package static func parse(_ object: [String: Any], currentVersion: String) -> NativeUpdateCheckResult {
    ...
    package static func normalizedReleaseNotes(from body: String) -> [String] {
        body
