...
package enum EnginePaths {
    ...
    package static func repositoryRoot() throws -> URL {
    ...
    package static func engineEntryURL() throws -> URL {
    ...
    package static func nativeScriptURL(named name: String) throws -> URL {
    ...
    package static func nodeExecutableURL() throws -> URL {
