...
package enum AppLanguageMode: String, Codable, CaseIterable, Identifiable {
    ...
    package var pickerLabel: String {
        pickerLabel(in: WordZLocalization.resolveSystemMode())
    }

    package func pickerLabel(in displayMode: AppLanguageMode) -> String {
        switch self {
        case .system:
...
package final class WordZLocalization: ObservableObject {
    ...
    package var effectiveMode: AppLanguageMode {
    ...
    package func updatePreferredMode(_ mode: AppLanguageMode) {
    ...
    package func text(_ key: String, table: String? = nil, fallback: String? = nil) -> String {
        Self.text(forKey: key, table: table, mode: preferredMode, fallback: fallback)
    }

    package func text(_ zh: String, _ en: String) -> String {
        Self.text(forKey: zh, mode: preferredMode, fallback: en)
    }

    package func format(_ key: String, table: String? = nil, fallback: String? = nil, _ args: CVarArg...) -> String {
        Self.formatted(forKey: key, table: table, mode: preferredMode, fallback: fallback, arguments: args)
    }

    package nonisolated static func resolveSystemMode() -> AppLanguageMode {
    ...
    package nonisolated static func resolveEffectiveMode(for preferredMode: AppLanguageMode) -> AppLanguageMode {
        preferredMode == .system ? resolveSystemMode() : preferredMode
    }

    package nonisolated static func locale(for preferredMode: AppLanguageMode) -> Locale {
    ...
    package nonisolated static func bundle(for preferredMode: AppLanguageMode) -> Bundle {
        switch resolveEffectiveMode(for: preferredMode) {
        case .system:
    ...
    package nonisolated static func text(
        forKey key: String,
        table: String? = nil,
    ...
    package nonisolated static func formatted(
        forKey key: String,
        table: String? = nil,
        mode: AppLanguageMode,
        fallback: String? = nil,
    ...
    package nonisolated static func localizedDateTimeString(
        from date: Date,
        mode: AppLanguageMode,
    ...
    package nonisolated static func normalizedPreferredMode(_ mode: AppLanguageMode) -> AppLanguageMode {
        _ = mode
        return .system
    }
}

package func wordZText(_ zh: String, _ en: String, mode: AppLanguageMode) -> String {
    WordZLocalization.text(forKey: zh, mode: mode, fallback: en)
}

package func l10n(_ key: String, table: String? = nil, mode: AppLanguageMode = .system, fallback: String? = nil) -> String {
    WordZLocalization.text(forKey: key, table: table, mode: mode, fallback: fallback)
}

package func l10nFormat(
    _ key: String,
    table: String? = nil,
...
package struct L10nText: View {
    ...
    package init(_ key: String, table: String? = nil, fallback: String? = nil) {
        self.key = key
        self.table = table
...
extension EnvironmentValues {
    package var wordZLanguageMode: AppLanguageMode {
