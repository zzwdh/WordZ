...
package struct StorageMutationCoordinator {
    package let fileManager: FileManager
    package let stagingRootURL: URL

    package init(fileManager: FileManager, stagingRootURL: URL) {
        self.fileManager = fileManager
        self.stagingRootURL = stagingRootURL
    }

    package func perform<T>(_ body: (StorageMutationTransaction) throws -> T) throws -> T {
...
package final class StorageMutationTransaction {
    ...
    package init(fileManager: FileManager, stagingRootURL: URL) throws {
        self.fileManager = fileManager
    ...
    package func snapshotDatabase(at databaseURL: URL, configuration: SQLiteDatabaseConfiguration) throws {
    ...
    package func registerRollback(_ action: @escaping () -> Void) {
