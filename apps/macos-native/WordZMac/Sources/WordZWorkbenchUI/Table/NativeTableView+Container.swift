...
extension NativeTableView {
    ...
    final class ActionTableView: NSTableView {
        ...
        var copyPasteboard: any NativeTablePasteboardWriting = NSPasteboard.general
        ...
        override func keyDown(with event: NSEvent) {
            if event.modifierFlags.intersection(.deviceIndependentFlagsMask) == .command,
               ...
               actionCoordinator?.copySelectedRowsToPasteboard(copyPasteboard) == true {
                return
            }
        ...
        func copy(_ sender: Any?) {
            _ = actionCoordinator?.copySelectedRowsToPasteboard(copyPasteboard)
        }
    ...
    package final class IntrinsicTableContainerView: NSView {
