...
package struct NativeTableView: NSViewRepresentable {
    ...
    package func makeNSView(context: Context) -> IntrinsicTableContainerView {
    ...
    package func updateNSView(_ containerView: IntrinsicTableContainerView, context: Context) {
        context.coordinator.apply(
            descriptor: descriptor,
            rows: rows,
            snapshot: snapshot,
