...
enum EngineStdoutEvent: Equatable {
...
enum EngineProtocolSupport {
    static func makeRequestData(id: String, method: String, params: JSONObject? = nil) throws -> Data {
    ...
    static func decodeInvokeResult(from data: Data) throws -> JSONObject {
    ...
    static func decodeTaskPayload(taskId: String, from data: Data) throws -> JSONObject {
    ...
    static func classifyStdoutEvent(from object: JSONObject) -> EngineStdoutEvent {
