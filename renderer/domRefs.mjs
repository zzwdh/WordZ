...
export const dom = {
  ...
  ngramFilterInput: document.getElementById('ngramFilterInput'),
  ...
  stopwordToggleInputs: Array.from(document.querySelectorAll('[data-stopword-toggle]')),
  stopwordModeSelects: Array.from(document.querySelectorAll('[data-stopword-mode]')),
  stopwordEditButtons: Array.from(document.querySelectorAll('[data-stopword-edit]')),
  stopwordSummaryNodes: Array.from(document.querySelectorAll('[data-stopword-summary]')),
  ...
  stopwordModal: document.getElementById('stopwordModal'),
  stopwordModalContext: document.getElementById('stopwordModalContext'),
  stopwordListTextarea: document.getElementById('stopwordListTextarea'),
  stopwordListCount: document.getElementById('stopwordListCount'),
  saveStopwordListButton: document.getElementById('saveStopwordListButton'),
  closeStopwordModalButton: document.getElementById('closeStopwordModalButton'),
  resetStopwordListButton: document.getElementById('resetStopwordListButton'),
  clearStopwordListButton: document.getElementById('clearStopwordListButton'),
  ...
  uiAccentSelect: document.getElementById('uiAccentSelect'),
  ...
  autoUpdateEnabledToggle: document.getElementById('autoUpdateEnabledToggle'),
  autoUpdateCheckOnLaunchToggle: document.getElementById('autoUpdateCheckOnLaunchToggle'),
  autoUpdateAutoDownloadToggle: document.getElementById('autoUpdateAutoDownloadToggle'),
  ...
  themeAccentValue: document.getElementById('themeAccentValue'),
  themeAccentStatusText: document.getElementById('themeAccentStatusText'),
  autoUpdatePreferenceValue: document.getElementById('autoUpdatePreferenceValue'),
  autoUpdatePreferenceStatusText: document.getElementById('autoUpdatePreferenceStatusText'),
